...
void ceresOptimizer_sophusSE3(vector<std::shared_ptr<Frame> >& frames, bool pointToPlane, bool robust,
                              bool automaticDiffLocalParam = true);
...
struct PointToPointErrorGlobal {
  ...
  PointToPointErrorGlobal(const Eigen::Vector3d& dst, const Eigen::Vector3d& src) : p_dst(dst), p_src(src) {}

  // Factory to hide the construction of the CostFunction object from the client code.
  static ceres::CostFunction* Create(const Eigen::Vector3d& dst, const Eigen::Vector3d& src) {
    return (
        new ceres::AutoDiffCostFunction<PointToPointErrorGlobal, 3, 4, 3, 4, 3>(new PointToPointErrorGlobal(dst, src)));
  }

  template <typename T>
  bool operator()(const T* const camera_rotation, const T* const camera_translation, const T* const camera_rotation_dst,
                  const T* const camera_translation_dst, T* residuals) const {
...
struct PointToPlaneErrorGlobal {
  ...
  static ceres::CostFunction* Create(const Eigen::Vector3d& dst, const Eigen::Vector3d& src,
    ...
    return (new ceres::AutoDiffCostFunction<PointToPlaneErrorGlobal, 1, 4, 3, 4, 3>(
        new PointToPlaneErrorGlobal(dst, src, nor)));
  }
...
struct PointToPointErrorGlobal_CeresAngleAxis {
  ...
  static ceres::CostFunction* Create(const Eigen::Vector3d& observed, const Eigen::Vector3d& worldPoint) {
    return (new ceres::AutoDiffCostFunction<PointToPointErrorGlobal_CeresAngleAxis, 3, 6, 6>(
        new PointToPointErrorGlobal_CeresAngleAxis(observed, worldPoint)));
  }
...
struct PointToPlaneErrorGlobal_CeresAngleAxis {
  ...
  PointToPlaneErrorGlobal_CeresAngleAxis(const Eigen::Vector3d& dst, const Eigen::Vector3d& src,
                                         const Eigen::Vector3d& nor)
      : p_dst(dst), p_src(src), p_nor(nor) {
    //        cout<<nor.dot(nor)<<endl;
  }
  ...
  static ceres::CostFunction* Create(const Eigen::Vector3d& dst, const Eigen::Vector3d& src,
                                     const Eigen::Vector3d& nor) {
    return (new ceres::AutoDiffCostFunction<PointToPlaneErrorGlobal_CeresAngleAxis, 1, 6, 6>(
        new PointToPlaneErrorGlobal_CeresAngleAxis(dst, src, nor)));
  }
  ...
  bool operator()(const T* const cam1, const T* const cam2, T* residuals) const {
    ...
    // The error is the difference between the predicted and observed position projected onto normal
    residuals[0] = (p1[0] - p2[0]) * nor[0] + (p1[1] - p2[1]) * nor[1] + (p1[2] - p2[2]) * nor[2];
...
struct PointToPointErrorGlobal_SophusSE3 {
  ...
  PointToPointErrorGlobal_SophusSE3(const Eigen::Vector3d& dst, const Eigen::Vector3d& src) : p_dst(dst), p_src(src) {}

  // Factory to hide the construction of the CostFunction object from the client code.
  static ceres::CostFunction* Create(const Eigen::Vector3d& dst, const Eigen::Vector3d& src) {
    return (
        new ceres::AutoDiffCostFunction<PointToPointErrorGlobal_SophusSE3, 3, Sophus::SE3d::num_parameters,
                                        Sophus::SE3d::num_parameters>(new PointToPointErrorGlobal_SophusSE3(dst, src)));
  }
...
struct PointToPlaneErrorGlobal_SophusSE3 {
  ...
  static ceres::CostFunction* Create(const Eigen::Vector3d& dst, const Eigen::Vector3d& src,
                                     const Eigen::Vector3d& nor) {
    return (new ceres::AutoDiffCostFunction<PointToPlaneErrorGlobal_SophusSE3, 1, Sophus::SE3d::num_parameters,
                                            Sophus::SE3d::num_parameters>(
        new PointToPlaneErrorGlobal_SophusSE3(dst, src, nor)));
  }
...
struct PointToPointError_CeresAngleAxis {
  ...
  PointToPointError_CeresAngleAxis(const Eigen::Vector3d& dst, const Eigen::Vector3d& src) : p_dst(dst), p_src(src) {}

  // Factory to hide the construction of the CostFunction object from the client code.
  static ceres::CostFunction* Create(const Eigen::Vector3d& observed, const Eigen::Vector3d& worldPoint) {
    return (new ceres::AutoDiffCostFunction<PointToPointError_CeresAngleAxis, 3, 6>(
        new PointToPointError_CeresAngleAxis(observed, worldPoint)));
  }
...
struct PointToPointError_EigenQuaternion {
  ...
  PointToPointError_EigenQuaternion(const Eigen::Vector3d& dst, const Eigen::Vector3d& src) : p_dst(dst), p_src(src) {}

  // Factory to hide the construction of the CostFunction object from the client code.
  static ceres::CostFunction* Create(const Eigen::Vector3d& observed, const Eigen::Vector3d& worldPoint) {
    return (new ceres::AutoDiffCostFunction<PointToPointError_EigenQuaternion, 3, 4, 3>(
        new PointToPointError_EigenQuaternion(observed, worldPoint)));
  }
...
struct PointToPointError_SophusSE3 {
  ...
  PointToPointError_SophusSE3(const Eigen::Vector3d& dst, const Eigen::Vector3d& src) : p_dst(dst), p_src(src) {}

  // Factory to hide the construction of the CostFunction object from the client code.
  static ceres::CostFunction* Create(const Eigen::Vector3d& observed, const Eigen::Vector3d& worldPoint) {
    return (new ceres::AutoDiffCostFunction<PointToPointError_SophusSE3, 3, 7>(
        new PointToPointError_SophusSE3(observed, worldPoint)));
  }
  ...
  bool operator()(const T* const cam1, T* residuals) const {
    ...
    p << T(p_src[0]), T(p_src[1]), T(p_src[2]);
...
struct PointToPlaneError_CeresAngleAxis {
  ...
  static ceres::CostFunction* Create(const Eigen::Vector3d& observed, const Eigen::Vector3d& worldPoint,
    ...
    return (new ceres::AutoDiffCostFunction<PointToPlaneError_CeresAngleAxis, 1, 6>(
        new PointToPlaneError_CeresAngleAxis(observed, worldPoint, normal)));
  }
  ...
  bool operator()(const T* const camera, T* residuals) const {
    ...
    // The error is the difference between the predicted and observed position.
    residuals[0] =
        (p[0] - T(p_dst[0])) * T(p_nor[0]) + (p[1] - T(p_dst[1])) * T(p_nor[1]) + (p[2] - T(p_dst[2])) * T(p_nor[2]);
...
struct PointToPlaneError_EigenQuaternion {
  ...
  static ceres::CostFunction* Create(const Eigen::Vector3d& observed, const Eigen::Vector3d& worldPoint,
                                     const Eigen::Vector3d& normal) {
    return (new ceres::AutoDiffCostFunction<PointToPlaneError_EigenQuaternion, 1, 4, 3>(
        new PointToPlaneError_EigenQuaternion(observed, worldPoint, normal)));
  }
  ...
  bool operator()(const T* const camera_rotation, const T* const camera_translation, T* residuals) const {
    // Make sure the Eigen::Vector world point is using the ceres::Jet type as it's Scalar type
    Eigen::Matrix<T, 3, 1> point;
    point << T((double)p_src[0]), T((double)p_src[1]), T((double)p_src[2]);
    ...
    Eigen::Matrix<T, 3, 1> point2;
    point2 << T((double)p_dst[0]), T((double)p_dst[1]), T((double)p_dst[2]);
    Eigen::Matrix<T, 3, 1> normal;
    normal << T((double)p_nor[0]), T((double)p_nor[1]), T((double)p_nor[2]);
...
struct PointToPlaneError_SophusSE3 {
  ...
  static ceres::CostFunction* Create(const Eigen::Vector3d& observed, const Eigen::Vector3d& worldPoint,
                                     const Eigen::Vector3d& normal) {
    return (new ceres::AutoDiffCostFunction<PointToPlaneError_SophusSE3, 1, 7>(
        new PointToPlaneError_SophusSE3(observed, worldPoint, normal)));
  }
  ...
  bool operator()(const T* const cam1, T* residuals) const {
    ...
    p << T(p_src[0]), T(p_src[1]), T(p_src[2]);
    Eigen::Matrix<T, 3, 1> point2;
    point2 << T(p_dst[0]), T(p_dst[1]), T(p_dst[2]);
    Eigen::Matrix<T, 3, 1> normal;
    normal << T(p_nor[0]), T(p_nor[1]), T(p_nor[2]);
